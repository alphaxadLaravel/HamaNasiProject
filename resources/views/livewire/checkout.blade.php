            ...
            <div class="col-md-6">
                <div class="card border-0 shadow-sm rounded overflow-hidden">
                    <div class="position-relative overflow-hidden">
                        <a href="/property/"><img class="img-fluid w-100" height="250px"
                                src="{{ asset('images/property-2.jpg') }}" alt=""></a>
                        <div class="bg-primary rounded text-white position-absolute start-0 bottom-0 m-4 py-1 px-3">
                            <small>HNC #1223</small>
                           <p class="py-2">For Sell | Price: 20,000,000 | Kinondoni, Dar-es-Salaam  </p>
                        </div>
                    </div>
                                        ...
                                        <div class="row justify-content-between align-items-center">
                                            <div class="col-auto">
                                                <div class="item-label"><img
                                                        src="{{ asset('images/airtelpesa.png') }}" class="rounded"
                                                        width="30px" height="30px" alt=""><strong> Airtel
                                                        Money </strong></div>
                                            </div>
                                            <div class="col text-end">
                                                <div class="form-check">
                                        ...
                                        <div class="row justify-content-between align-items-center">
                                            ...
                                            <div class="col text-end">
                                                <div class="form-check">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input"
                                                            style="cursor: pointer;" wire:model="branch"
                                                            id="" value="M-Pesa">
                                                    </label>
                                                </div>
                                            </div>
