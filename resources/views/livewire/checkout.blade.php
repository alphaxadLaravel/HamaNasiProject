                ...
                <div class="app-card-body px-4 w-100">
                    <div class="col-md-12">
                        <div class="item border-bottom py-3">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-auto">
                                    <div class="item-label"><img src="{{ asset('images/mpesa.png') }}" class="rounded"
                                            width="30px" height="30px" alt=""><strong>
                                            M-Pesa </strong></div>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="item border-bottom py-3">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-auto">
                                    <div class="item-label"><img src="{{ asset('images/tigopesa.png') }}" width="30px"
                                            height="30px" alt=""><strong> Tigo Pesa
                                        </strong></div>
                                </div>
                                <div class="col text-end">
                                    <div class="form-check">
                    ...
                    <div class="col-md-12">
                        <div class="item border-bottom py-3">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-auto">
                                    <div class="item-label"><img src="{{ asset('images/master.png') }}" class="rounded"
                                            width="30px" height="30px" alt=""><strong>
                    ...
                    <div class="app-card-body px-4 w-100">
                        <form action="" method="POST">
                            ...
                            <div class="row mt-4 px-4">
                                <button type="submit" class="btn btn-primary w-100 text-white">Pay Now</button>
                            </div>
                        </form>
